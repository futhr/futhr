...
It is the evidence side of the thesis for the physical world, where verification and recovery are measured rather than assumed, and its findings feed the open Web of Things work in WoTEx. Orvane is presented only as a research lab; architecture, scale, partners, deployment targets, and product relationships are not part of its public record.

*Findings from the edge, published as research.*
