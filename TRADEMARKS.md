...
The MIT licence in [LICENSE.md](LICENSE.md) covers application code only. It grants
no rights in any name, wordmark, symbol, or visual identity, whether or not the
files that draw them are in this repository.
...
identity or in a way that suggests sponsorship, endorsement, or affiliation.
...
For any other use, write to [hi@futhr.io](mailto:hi@futhr.io) first.
